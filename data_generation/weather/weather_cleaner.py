...
HF_ROOT = os.environ["DATA_ROOT"]  # ./hugging_face
DATA_ROOT = os.path.join(HF_ROOT, "BERLIN_reduced")
...
if __name__ == "__main__":
    clean_weather(
        weather_root=os.environ["WEATHER_INTEREST_ROOT"],
        splits_file=os.path.join(DATA_ROOT, "splits", "splits.json"),
        out_root=os.environ["WEATHER_ROOT"],
    )